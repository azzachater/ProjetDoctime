...
function Nav(){
    ...
    <div className="container">
      <a className="navbar-brand" href="index.html">DocTime</a>
      ...
      <div className="collapse navbar-collapse" id="ftco-nav" >
        <ul className="navbar-nav nav ml-auto">
          ...
          <li className="nav-item"><a href="#department-section" className="nav-link"><span>Department</span></a></li>
          <li className="nav-item"><a href="#doctor-section" className="nav-link"><span>Doctors</span></a></li>
          ...
          <li className="nav-item cta mr-md-2"><a href="appointment.html" className="nav-link">Appointment</a></li>
        </ul>
      </div>
    </div>
    </nav>);
