...
function Home() {
  return (
    <section class="hero-wrap js-fullheight" style={{backgroundImage: `url(${process.env.PUBLIC_URL}/assets/images/bg_3.jpg)`}} data-section="home" data-stellar-background-ratio="0.5">
      <div class="overlay"></div>
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-start" data-scrollax-parent="true">
          <div class="col-md-6 pt-5 ftco-animate">
          	<div class="mt-5">
          		<span class="subheading">Welcome to DocTime</span>
